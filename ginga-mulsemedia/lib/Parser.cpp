...
ParserState::pushEffect (ParserState *st, ParserElt *elt)
{
  ...
  /*if (hasRefer)	
    ...
    // create Effect if not found refer that created the referred Effect	
    //if (!st->referMapIndex (id, &effect))	
    //  {	
  ...
  //TO DO: modificar a classe Vertex para aceitar objetos do tipo Effect
